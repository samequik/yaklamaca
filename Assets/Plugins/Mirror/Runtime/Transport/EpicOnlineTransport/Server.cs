...
namespace EpicTransport {
    public class Server : Common {
        ...
        public static Server CreateServer(EosTransport transport, int maxConnections) {
            ...
            // Mirror'in hata olayi artik uc parametreli: (baglanti, tur, metin).
            // Bu transport Mirror v44 doneminden kalma ve iki parametreyle
            // cagiriyordu. Tur olarak Unexpected veriliyor cunku EOS'tan gelen
            // istisna Mirror'in kategorilerine birebir oturmuyor; metin de
            // istisnanin kendi mesaji.
            s.OnReceivedError += (id, exception) =>
                transport.OnServerError.Invoke(id, TransportError.Unexpected, exception.Message);
